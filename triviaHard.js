  ...
  trivia: [
    {
      ...
      'answers': ['Help!', 'Revolver', 'Rubber Soul', 'Abbey Road']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['Rocket Man', 'Bennie and the Jets', 'Goodbye Yellow Brick Road', 'Crocodile Rock']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['Elton John','John Denver', 'Billy Joel', 'Joe Cocker']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['Windowlicker', 'Drukqs', 'Syro', 'Collected Ambient Works 85-92']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['Prince - &quot;1999&quot;', 'James Blunt - &quot;1973&quot;', 'David Bowie - &quot;1984&quot;', 'The Smashing Pumpkins - &quot;1979&quot;']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['Ringo Starr', 'Stuart Sutcliffe', 'Tommy Moore', 'Pete Best']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': [ 'Famous','Wolves', 'Ultralight Beam', 'Highlights']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['Saturdays = Youth', 'Hurry Up, We&#039;re Dreaming', 'Before the Dawn Heals Us', 'Junk']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['Morrissey', 'Andy Rourke', 'Mike Joyce','Martin Chambers']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['Caustic Window', 'Bradley Strider', 'GAK', 'Burial']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': [ 'Skrillex', 'Ti&euml;sto', 'Slushii', 'Dash Berlin']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['&amp;&amp;&amp;&amp;&amp;&amp;', 'Sheep', 'Xen','Entra&ntilde;as']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      'question': 'What is the British term for a 64th no64te?',
      'correct_answer': 'Hemidemisemiquaver',
      'answers': ['Semihemidemisemiquaver', 'Hemidemisemiquaver','Semiquaver', 'Demisemiquaver']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['Blue Devils', 'The Academy', 'Santa Clara Vanguard', 'The Bluecoats']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'correct_answer': 'U2',
      'answers': [ 'U2','Radiohead', 'Rush', 'Rolling Stones']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['What About Us', 'This Song Is Not About A Girl', 'Drop The Game', 'Left Alone']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['Bottomless Pit', 'The Money Store', 'No Love Deep Web', 'The Powers That B']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['Let The Sparks Fly', 'Down', 'Limitless Fury', 'Give Up The Ghost']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['Lucky Lady Feel So Good ', 'Merry-Go Round', 'Let&#039;s Dance Baby', 'Love Talkin&#039;']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['Lisa Frank 420 \/ Modern Computing', 'Smoke Weed 420 \/ Everyday', 'Make Your Move 420 \/ My Mind', 'It&#039;s All In Your Head 420 \/ Understand']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['Heathens - Twenty One Pilots', 'Skies on Fire - AC\/DC', 'Without Me - Eminem', 'Fortunate Son - Creedence Clearwater Revival']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
      ...
      'answers': ['Detroit', 'Compton', 'New York', 'Baltimore']
    }, {
      'category': 'Entertainment: Music',
      'type': 'multiple',
      'difficulty': 'hard',
